...
export const pipelineRunners=['vpipe','comfyui'] as const;
...
export const pipelineMetadata=z.object({
  ...
  bindings:z.partialRecord(z.enum(['prompt','seed','width','height','frames','duration','output','pixels','device']),z.array(binding)).default({}),
