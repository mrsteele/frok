...
export function LegalNotice() {
  ...
  return <aside className="legal-notice" aria-label="Your content and responsibility">
    ...
    <p>Frok is open source (GPL-3.0-only). Everything Frok stores for your studio—including prompts, media, settings and logs—stays on your device. Its developers collect none of this data; the app has no built-in reporting channel or developer remote access.</p>
