...
const privatePath = /(?:^|\/)(?:node_modules|\.data|\.desktop|\.next(?:-[^/]+)?|\.npm-cache|release|\.codex|\.claude|\.agents)(?:\/|$)|(?:^|\/)\.env(?![^/]*\.example$)(?:\.|$)|\.local(?:\/|\.)|\.(?:safetensors|gguf|ggml|ckpt|pt|pth|onnx|sqlite(?:3)?(?:-[^/]*)?|db(?:-[^/]*)?|pem|key|p12|pfx|dmg|pkg|exe|AppImage|tar\.gz|mp4|mov|webm)$/i;
