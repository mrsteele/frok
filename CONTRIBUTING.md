...
Bug reports, documentation, workflow examples, accessibility improvements and code contributions are welcome.
...
Contributions are accepted under [the project license](LICENSE). You retain copyright in your contribution; there is no copyright assignment. Only submit work you have permission to share under these terms. Identify third-party material and preserve its notices.
